{
  ...
  "sources": {
    ...
    "openmaptiles": {
      "type": "vector",
      "url": "https://maps.carrismetropolitana.pt/data/openmaptiles.json"
    }
  },
  ...
  "layers": [
    {
      "id": "background",
      "type": "background",
      "paint": {"background-color": "rgba(241, 241, 232, 1)"}
    },
    {
      "id": "park",
      "type": "fill",
      ...
      "paint": {"fill-color": "rgba(205, 224, 197, 1)"}
    },
    {
      "id": "water",
      "type": "fill",
      ...
      "paint": {"fill-antialias": true, "fill-color": "rgba(177, 210, 222, 1)"}
    },
    {
    ...
    },
    {
      ...
      "paint": {"line-color": "rgba(189, 211, 220, 1)"}
    },
    {
      "id": "building",
      "type": "fill",
